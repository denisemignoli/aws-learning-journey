...
A nuvem AWS oferece um conjunto de vantagens que transformam a maneira como as aplicações são construídas e operadas. Enquanto os **benefícios financeiros** (como a troca de CAPEX por OPEX e a redução do TCO) são detalhados na nota sobre a [[aws_value_proposition|Proposta de Valor da AWS]], este documento foca nos principais **benefícios técnicos**:
